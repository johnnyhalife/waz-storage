...
- Added __naming validation for Containers__ according to http://msdn.microsoft.com/en-us/library/dd135715.aspx (thanks @panosjee)
- Added __naming validation for Queues__ according to http://msdn.microsoft.com/en-us/library/dd179349.aspx (thanks @panosjee)
- Added __support for Blob snapshots__ 
...
Here's a quick getting started of the usage of the API:
	...
	# NEW! Now you can do __ensure__ and it will return the queue, first trying to retrieve it 
