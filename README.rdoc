...
The main difference with the original library is the adding of the methods "railsetage"
This method add to any blob object an "x_ms_meta_railsetag" header, which value is calculated as a rails etag (Digest::MD5.hexdigest(file))
